...
public class EmployeeCompany
{
	...
	//Constructor
	public EmployeeCompany(String companyName, int empRatePerHour, int numOfWorkingDays, int maxHoursPerMonth)
	{
	...
	public static void main(String[] args)
	{
		...
		EmployeeCompany dmart=new EmployeeCompany("DMART", 20, 20, 100);
		System.out.println("Total Employee Wage Of "+dmart.companyName+" is "+dmart.empCheck());
		System.out.println();
		//Created and Initialise Object
		EmployeeCompany reliance=new EmployeeCompany("Reliance", 30, 25, 90);
